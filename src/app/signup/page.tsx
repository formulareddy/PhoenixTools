...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error: authError, message, autoSignedIn } = await signUp(email, password, username)
  ...
  return (
    <div className="min-h-screen flex bg-[#1a1a1a] relative overflow-hidden">
      ...
      <div className="absolute top-[10%] right-[10%] w-2 h-2 rounded-full bg-[#D97757]/20 animate-[float-up_4s_ease-in-out_infinite]" />
      <div className="absolute top-[30%] left-[6%] w-1.5 h-1.5 rounded-full bg-[#D97757]/15 animate-[float-up_5s_ease-in-out_infinite_0.5s]" />
      <div className="absolute bottom-[25%] right-[8%] w-1 h-1 rounded-full bg-[#D97757]/10 animate-[float-up_3.5s_ease-in-out_infinite_1s]" />
      <div className="absolute bottom-[15%] left-[12%] w-2.5 h-2.5 rounded-full bg-[#D97757]/15 animate-[float-up_4.5s_ease-in-out_infinite_0.3s]" />
      <div className="absolute top-[55%] right-[5%] w-1.5 h-1.5 rounded-full bg-[#D97757]/10 animate-[float-up_5.5s_ease-in-out_infinite_0.8s]" />

      {/* Left: Form Card */}
      <div className="flex-1 flex flex-col justify-center items-center px-6 sm:px-10 py-10 order-2 lg:order-1">
          ...
          <AnimatedCardBorder delay={0.35} className="p-7 sm:p-8">
            ...
            {success && (
              <div className="space-y-3">
                <div className="flex items-center gap-2 p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 animate-[slide-in_0.3s_ease-out]">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 flex-shrink-0" />
                  <p className="text-[13px] text-emerald-400">{success}</p>
                </div>
                <Link
                  href="/signin"
                  className="block text-center text-[13px] text-[#D97757] hover:text-[#D97757]/80 transition-colors"
                >
                  Go to Sign In →
                </Link>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="animate-[slide-in_0.4s_ease-out]" style={{ animationDelay: "0.4s", animationFillMode: "both" }}>
                <label className="block text-[13px] text-[#BEB7AC] mb-1.5">Username</label>
                <input
                  type="text"
              ...
              <div className="animate-[slide-in_0.4s_ease-out]" style={{ animationDelay: "0.55s", animationFillMode: "both" }}>
                <label className="block text-[13px] text-[#BEB7AC] mb-1.5">Confirm Password</label>
                <div className="relative">
                  <input
                    ...
                    required
                    className={cn(
                      "w-full px-4 pr-10 py-2.5 rounded-xl bg-[#e8e4dc] text-[14px] text-[#1a1a1a] placeholder-[#888] outline-none transition-all",
                      confirm && password !== confirm
                        ? "ring-2 ring-red-400/60"
                        : "focus:ring-2 focus:ring-[#D97757]/40"
                    )}
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                className={cn(
                  ...
                  (loading || (confirm !== "" && password !== confirm)) && "opacity-70 cursor-not-allowed"
                )}
            ...
            <p className="mt-5 text-center text-[13px] text-[#BEB7AC] animate-[float-up_0.5s_ease-out]" style={{ animationDelay: "0.7s", animationFillMode: "both" }}>
              ...
              <Link href="/signin" className="text-[#F6F3EE] font-semibold hover:underline">
                Login Now
              </Link>
            </p>
          </AnimatedCardBorder>
      ...
      {/* Right: Illustration + Heading */}
      <div className="hidden lg:flex flex-1 flex-col items-center justify-center relative px-8 order-1 lg:order-2">
        <h1
